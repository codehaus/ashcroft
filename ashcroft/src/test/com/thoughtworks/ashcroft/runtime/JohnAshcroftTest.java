...
public class JohnAshcroftTest extends TestCase {
    ...
    public void testShouldNotAllowCreationOfTempFile() throws IOException {
        try {
            ...
            assertEquals("You can't write to files during unit tests", expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowReadingOfFiles() throws IOException {
        ...
        try {
            ...
            assertEquals("You can't read from files during unit tests: " + fileName, expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowToCheckForFilePresence() {
        ...
        try {
            ...
            assertEquals("You can't check for file presence during unit tests: " + fileName, expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowToCreateDirectories() {
        ...
        try {
            ...
            assertEquals("You can't create directories during unit tests: " + fileName, expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowOpeningSockets() throws IOException {
        try {
            ...
            assertEquals("You can't open sockets during unit tests", expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowServerSockets() throws IOException {
        try {
            ...
            assertEquals("You can't listen for incoming sockets during unit tests", expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowCheckingURLsForEqualityBecauseStupidURLImplementationWantsToGoOnline() throws IOException {
        try {
            ...
            assertEquals("You can't compare URLs during unit tests", expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowCreationOfNewThreadObject() {
        try {
            ...
            assertEquals("You can't start threads during unit tests", expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowDisplayOfFrames() {
        try {
            ...
            assertEquals("You can't use AWT during unit tests", expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowExitingVM() {
        try {
            ...
            assertEquals("You can't exit the JVM during unit tests", expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowSettingAnotherSecurityManager() {
        try {
            ...
            assertEquals("Thou shalt have no other security managers before me", expected.getMessage());
        }
    }
    ...
    public void TODOtestShouldNotAllowAccessingAndModifyingSystemProperties() {
        try {
            ...
            assertEquals("You can't call System.getProperties() during unit tests", expected.getMessage());
        }
    }
    ...
    public void testShouldNotAllowSettingSystemProperty() {
        try {
            ...
            assertEquals("You can't set system properties during unit tests", expected.getMessage());
        }
    }
